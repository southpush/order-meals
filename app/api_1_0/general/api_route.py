...
from app.api_1_0.general.api_general import region, user_shop_head_image, user_personal_head_image, shop_image, \
    shop_item_image, shop_license_idcard_image, shop_license_business_image, shop_license_service_image
...
api_general.add_resource(shop_license_idcard_image, "/shop_license_idcard_image",
                         "/shop_license_idcard_image/<image_name>")
api_general.add_resource(shop_license_business_image, "/shop_license_business_image",
                         "/shop_license_business_image/<image_name>")
api_general.add_resource(shop_license_service_image, "/shop_license_service_image",
                         "/shop_license_service_image/<image_name>")