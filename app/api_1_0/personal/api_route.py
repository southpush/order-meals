...
from .api_food import nearby_shop, personal_orders, personal_orders_list, personal_favorites, order_pay, order_cancel
...
api_personal.add_resource(personal_favorites, "/favorites")
api_personal.add_resource(order_pay, "/order_pay")
api_personal.add_resource(order_cancel, "/order_cancel")
