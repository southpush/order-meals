...
Revision ID: a209625c85ea
Revises: 
Create Date: 2018-12-16 16:17:48.520271
...
def upgrade():
    ...
    sa.Column('region_name', sa.String(length=64, collation='utf8mb4_unicode_ci'), nullable=False),
    ...
    sa.Column('shop_img_id', sa.LargeBinary(), nullable=True),
